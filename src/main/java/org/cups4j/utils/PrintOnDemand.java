...
public class PrintOnDemand {
    ...
    public void print(String filePath)throws Exception{
        ...
        PrintJob pj = new PrintJob.Builder(fis).jobName("cups4j CommonsVFS direct printing test.").userName(System.getProperty("user.name") + "@" + localMachine.getHostName()).build();
